...
def print_file_name(print_file_name):
    print '{0}{1}{2}{3}'.format(Tag.info, Color.bold_green, print_file_name, Color.end)
...
def print_highlighted(field_name, field_value):
    print '{0}{1}{2}:\t\t{3}{4}{5}'.format(Tag.info, Color.bold_green, field_name, Color.bold_red, field_value, Color.end)
